...
function Login() {
  return (
    <>
      <div
        className="flex justify-center items-center min-h-screen bg-cover bg-center bg-blue-500"
        style={{ backgroundImage: `url(${bgImage})` }}
      >
        <div className="w-[420px] bg-transparent backdrop-blur-lg shadow-lg text-white rounded-lg p-8 border-2 border-white/20">
          <form>
